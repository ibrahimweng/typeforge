...
const EVERYWHERE = new Set([
  ...
  "does", "each", "for", "from", "has", "have", "how", "in", "into", "is", "it",
  "its", "make", "makes", "much", "not", "of", "on", "one", "or", "out", "over",
  "so", "than", "that", "the", "their", "them", "then", "there", "they", "this",
  "to", "up", "was", "what", "when", "where", "which", "while", "who", "will",
  "with", "would", "you", "your",
  ...
  "want", "wants", "need", "needs", "get", "got", "put", "give", "add",
  "look", "looks", "looking", "seem", "seems", "my", "me", "i", "too",
  "please", "just", "very", "really", "some", "any", "more", "less",
  // And the ones peculiar to this product.
  "font", "letter", "letters", "glyph", "glyphs", "stroke", "strokes", "shape",
  "shapes", "control", "controls", "face", "faces", "typeface",
]);
