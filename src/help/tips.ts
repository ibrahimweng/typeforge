...
export const TIPS: Record<TipId, string> = {
  ...
  forge:
    "Nothing here came from another font. Double-click any edge of the letter to get the control behind it, as a handle you can pull and as the row it lives on in the panel. The accented letters are built from the letters and marks you have already drawn, so \u00e9 follows the e and \u00f1 follows the n. Turn on Skeleton to see what is being drawn, and type into the specimen line to judge it in a word.",
  assemble:
